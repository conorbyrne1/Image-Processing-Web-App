...
import "./BrightnessAdjustment.css";

export default function BrightnessAdjustment() {
  ...
  const applyBrightnessAdjustment = () => {
    ...
    const result = adjustBrightness(srcData, brightnessValue);
  ...
  const downloadProcessed = () => {
    ...
    if (canvas.toBlob) {
      canvas.toBlob((blob) => {
        ...
        a.href = url;
        a.download = "brightness-adjusted-image.png";
        a.click();
  ...
  return (
    <div className="brightness-container">
      <header className="tool-header">
        ...
        <h1>Brightness Adjustment Tool</h1>
        <p>Adjust image brightness from -100 to +100.</p>
      </header>
      ...
      <div className="tool-content">
        <div className="upload-controls">
          ...
          <div className="brightness-controls">
            <label htmlFor="brightness-input">Brightness: {brightnessValue}</label>
            <input
              id="brightness-input"
              type="number"
              min="-100"
            ...
            />
            <button className="go-button" onClick={applyBrightnessAdjustment} disabled={!imageSrc}>
              Go
            </button>
          </div>
        </div>
